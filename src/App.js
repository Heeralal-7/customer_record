...
const Pill = ({ children, bg, color }) => (
  <span style={{
    background: bg, color, borderRadius: 6, padding: "3px 9px", fontSize: 11,
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <span style={{
            background: "#1a2a3a", color: "#60a5fa", borderRadius: 6,
            padding: "3px 8px", fontSize: 11, fontFamily: "'DM Mono',monospace", fontWeight: 700
          }}>{c.id}</span>
          {c.isNew && <span style={{
            background: "#2a1a3a", color: C.accent4, borderRadius: 6,
            padding: "2px 7px", fontSize: 10, fontFamily: "'DM Mono',monospace", fontWeight: 700
          }}>NEW</span>}
        </div>
    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'DM Sans',sans-serif", color: C.text }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: isMobile ? 14 : 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{
              background: "linear-gradient(135deg,#00d4aa22,#00d4aa44)", border: `1px solid ${C.accent}44`,
              borderRadius: 12, padding: isMobile ? "8px 10px" : "10px 14px", fontSize: isMobile ? 22 : 28
            }}>👔</div>
            <div>
              <h1 style={{
                margin: 0, fontSize: isMobile ? 18 : 24, fontWeight: 800, letterSpacing: .5,
                background: `linear-gradient(90deg,${C.accent},#00b4d8)`,
                WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"
              }}>
                Ashoka Textiles              </h1>
              <p style={{
                margin: 0, fontSize: isMobile ? 9 : 11, color: C.muted, letterSpacing: 2,
                textTransform: "uppercase", fontFamily: "'DM Mono',monospace"
              }}>Customer Records Manager</p>
            </div>
          </div>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={s.label} style={{
              ...
              <div style={{
                color: s.color, fontWeight: 800, fontSize: isMobile ? 14 : 17,
                fontFamily: "'DM Mono',monospace"
              }}>{s.value}</div>
              <div style={{
                color: C.muted, fontSize: isMobile ? 9 : 10, letterSpacing: .8,
      ...
      <div style={{ padding: isMobile ? "14px 14px 80px" : "16px 36px 48px" }}>
                  ...
                  return (
                    ...
                    >
                      <td style={{ padding: "12px 16px" }}>
                        <span style={{
                          background: "#1a2a3a", color: "#60a5fa", borderRadius: 6,
                          padding: "3px 9px", fontSize: 12, fontFamily: "'DM Mono',monospace", fontWeight: 600
                        }}>{c.id}</span>
                        {c.isNew && <span style={{
                          marginLeft: 6, background: "#2a1a3a", color: C.accent4,
                          borderRadius: 6, padding: "2px 7px", fontSize: 10, fontFamily: "'DM Mono',monospace", fontWeight: 700
                        }}>NEW</span>}
                      </td>
                      ...
                      <td style={{ padding: "12px 16px", textAlign: "center" }}>
                        <span style={{
                          background: "#1a1a3a", color: C.accent4, borderRadius: 6,
                          padding: "3px 10px", fontFamily: "'DM Mono',monospace", fontWeight: 700, fontSize: 13
                        }}>{c.qty}</span>
                      </td>
              ...
              {paginated.length > 0 && (
                <tfoot>
                  <tr style={{ background: "#0a1a12", borderTop: `2px solid ${C.accent}44` }}>
                    <td colSpan={7} style={{
                      padding: "11px 16px", fontFamily: "'DM Mono',monospace",
        ...
        {isMobile && (
          <div>
            ...
            {paginated.length > 0 && (
              <div style={{
                background: "#0a1a12", border: `1px solid ${C.accent}33`, borderRadius: 10,
        ...
        <p style={{
          textAlign: "center", marginTop: 10, color: C.muted,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
              <div>
                <h2 style={{
                  margin: 0, fontSize: isMobile ? 18 : 20, fontWeight: 800,
      ...
      {delId && (
        <div style={{
          ...
          <div style={{
            background: C.card, borderRadius: isMobile ? "18px 18px 0 0" : "16px",
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button onClick={() => setDelId(null)} style={{
                ...
                border: `1px solid ${C.border}`, background: "transparent", color: C.muted,
                cursor: "pointer", fontWeight: 700, fontFamily: "'DM Sans',sans-serif", fontSize: 14
              }}>Cancel</button>
              <button onClick={confirmDel} style={{
                flex: 1, padding: 13, borderRadius: 10,
                border: "none", background: C.accent2, color: "#fff",
                cursor: "pointer", fontWeight: 800, fontFamily: "'DM Sans',sans-serif", fontSize: 14,
                boxShadow: `0 4px 14px ${C.accent2}55`
              }}>Yes, Delete</button>
            </div>
          </div>
        </div>
